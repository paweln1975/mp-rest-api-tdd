...
class PrivateAPIRecipesTests(TestCase):
    ...
    def test_filter_recipes_by_tags(self):
        recipe1 = sample_recipe(user=self.user, title='Onion chips')
        recipe2 = sample_recipe(user=self.user, title='Test recipe')
        tag1 = sample_tag(user=self.user, name='Vegan')
    ...
    def test_filter_recipes_by_ingredients(self):
        ...
        ingredient2 = sample_ingredient(user=self.user, name='Test')
